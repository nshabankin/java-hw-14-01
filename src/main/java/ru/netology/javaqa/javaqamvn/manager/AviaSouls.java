...
public class AviaSouls {
    ...
    public Ticket[] search(String from, String to) {
        ...
        Arrays.sort(result); // сортировка массива по возрастанию
        return result;
    }

    /**
     * Метод поиска билетов по маршруту с заданным способом сортировки
     *
     * @param from       Откуда вылетаем
     * @param to         Куда прилетаем
     * @param comparator Каким способом сортируем
     * @return Массив из подходящих билетов
     */
    public Ticket[] searchAndSortBy(String from, String to, Comparator<Ticket> comparator) {
        ...
        Arrays.sort(result, comparator); // сортировка массива заданным способом
        return result;
    }
}
